...
public class Psdude extends JPanel implements Runnable {
    ...
    private void clockLayout(Graphics g) {
        ...
        //Draw Calendar Buttons(only black)
        g.setColor(Color.black);
        ...
        //String Written Text
        g.setColor(Color.blue);
        g.drawString("Clock Design By Srishti Aggarwal", 300, 100);
        g.drawString("Under the guidence of ", 180, 150);
        g.setColor(Color.black);
        g.setFont(new Font("TimesRoman", Font.BOLD, 35));
        g.drawString(" Mr.Manish Bhatia Sir", 500, 150);
        //Clock Lable
    ...
    public void paint(Graphics g) {
        ...
        // VALUE FOR CORDINATE AND VECTOR FORM
        int str[] = {0, 12, 24, 37, 48, 60, 70, 80, 89, 97, 103, 109, 114, 117, 119};
        ...
        if (i < 16) {
            xsec = (int) (str[i] + xOrigin);//375
            ysec = (int) (-str[n - 1 - i] + yOrigin);//360
        } else if (i <= 30) {
            ...
            ysec = (int) (-str[i - 45] + yOrigin);  // bug at -str
        ...
        if (j < 16) {
            ...
            xmin = (int) (-str1[n - 1 - j + 45] + xOrigin); // bug at -str
